        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              <h3 class="d-inline-block d-sm-none">Seagate HDD 500GB SATA </h3>
              <div class="col-12">
                <img src="../img/harddisk.png" class="hdd-image" alt="Hdd Image">
              </div>
              <div class="col-12 product-image-thumbs">
                <div class="product-image-thumb active"><img src="../img/2.png" alt="Hdd Image"></div>
                <div class="product-image-thumb" ><img src="../img/3.png" alt="Hdd Image"></div>
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <h3 class="my-3">Seagate HDD 500GB SATA</h3>
              <p>
                <?php
                // set partition
                $fs = "/";
